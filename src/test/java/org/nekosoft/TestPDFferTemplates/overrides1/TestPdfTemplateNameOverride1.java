package org.nekosoft.TestPDFferTemplates.overrides1;
 ...
 */
@PdfTemplateComponent(group = ROOT_REGISTRY, name = "overriden-template")
public class TestPdfTemplateNameOverride1<T> implements PdfTemplate<T> {
    @Override
